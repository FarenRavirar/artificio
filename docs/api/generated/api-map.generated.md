...
| GET | `/api/notifications` | ✅ high | `apps\glossario\backend\src\routes\notificationRoutes.ts` | 12 |
| USE | `/api/notifications` | ✅ high | `apps\glossario\backend\src\index.ts` | 90 |
| PATCH | `/api/notifications/:id/read` | ✅ high | `apps\glossario\backend\src\routes\notificationRoutes.ts` | 14 |
| PATCH | `/api/notifications/read-all` | ✅ high | `apps\glossario\backend\src\routes\notificationRoutes.ts` | 13 |
...
| GET | `/api/terms` | ✅ high | `apps\glossario\backend\src\routes\termRoutes.ts` | 10 |
| POST | `/api/terms` | ✅ high | `apps\glossario\backend\src\routes\termRoutes.ts` | 14 |
| USE | `/api/terms` | ✅ high | `apps\glossario\backend\src\index.ts` | 82 |
| DELETE | `/api/terms/:id` | ✅ high | `apps\glossario\backend\src\routes\termRoutes.ts` | 19 |
| PATCH | `/api/terms/:id` | ✅ high | `apps\glossario\backend\src\routes\termRoutes.ts` | 18 |
| PATCH | `/api/terms/:id/approve` | ✅ high | `apps\glossario\backend\src\routes\termRoutes.ts` | 17 |
| GET | `/api/terms/:id/history` | ✅ high | `apps\glossario\backend\src\routes\termRoutes.ts` | 11 |
...
| USE | `/api/v1/admin/discord` | ✅ high | `apps\mesas\backend\src\routes\adminDiscordSync.ts` | 21 |
| USE | `/api/v1/admin/discord` | ✅ high | `apps\mesas\backend\src\routes\adminDiscordSync.ts` | 29 |
| USE | `/api/v1/admin/discord/discovery` | ✅ high | `apps\mesas\backend\src\routes\adminDiscordSync.ts` | 20 |
...
| GET | `/api/v1/admin/discord/drafts` | ✅ high | `apps\mesas\backend\src\routes\discord\drafts.ts` | 14 |
| USE | `/api/v1/admin/discord/drafts` | ✅ high | `apps\mesas\backend\src\routes\adminDiscordSync.ts` | 24 |
| USE | `/api/v1/admin/discord/drafts` | ✅ high | `apps\mesas\backend\src\routes\adminDiscordSync.ts` | 25 |
| GET | `/api/v1/admin/discord/drafts/:id` | ✅ high | `apps\mesas\backend\src\routes\discord\drafts.ts` | 51 |
| PATCH | `/api/v1/admin/discord/drafts/:id` | ✅ high | `apps\mesas\backend\src\routes\discord\drafts.ts` | 68 |
| POST | `/api/v1/admin/discord/drafts/:id/refresh-image` | ✅ high | `apps\mesas\backend\src\routes\discord\drafts.ts` | 90 |
| POST | `/api/v1/admin/discord/drafts/:id/reparse` | ✅ high | `apps\mesas\backend\src\routes\discord\drafts.ts` | 106 |
...
| POST | `/api/v1/admin/discord/import-json` | ✅ high | `apps\mesas\backend\src\routes\discord\import.ts` | 47 |
| USE | `/api/v1/admin/discord/import-json` | ✅ high | `apps\mesas\backend\src\routes\adminDiscordSync.ts` | 30 |
| USE | `/api/v1/admin/discord/import-json` | ✅ high | `apps\mesas\backend\src\routes\adminDiscordSync.ts` | 31 |
| POST | `/api/v1/admin/discord/import-json/file` | ✅ high | `apps\mesas\backend\src\routes\discord\import.ts` | 64 |
...
| POST | `/api/v1/admin/discord/import-json/reparse` | ✅ high | `apps\mesas\backend\src\routes\discord\import.ts` | 83 |
| GET | `/api/v1/admin/discord/messages` | ✅ high | `apps\mesas\backend\src\routes\discord\messages.ts` | 58 |
| USE | `/api/v1/admin/discord/messages` | ✅ high | `apps\mesas\backend\src\routes\adminDiscordSync.ts` | 26 |
...
| PATCH | `/api/v1/admin/discord/messages/:id` | ✅ high | `apps\mesas\backend\src\routes\discord\messages.ts` | 95 |
| POST | `/api/v1/admin/discord/messages/:id/diagnose-content` | ✅ high | `apps\mesas\backend\src\routes\discord\messages.ts` | 117 |
...
| USE | `/api/v1/admin/discord/metrics` | ✅ high | `apps\mesas\backend\src\routes\adminDiscordSync.ts` | 32 |
...
| USE | `/api/v1/admin/discord/settings` | ✅ high | `apps\mesas\backend\src\routes\adminDiscordSync.ts` | 23 |
...
| USE | `/api/v1/admin/discord/sources` | ✅ high | `apps\mesas\backend\src\routes\adminDiscordSync.ts` | 22 |
...
| GET | `/api/v1/admin/import/drafts` | ✅ high | `apps\mesas\backend\src\routes\inbox\drafts.ts` | 17 |
...
| GET | `/api/v1/admin/import/drafts/:id` | ✅ high | `apps\mesas\backend\src\routes\inbox\drafts.ts` | 103 |
| PATCH | `/api/v1/admin/import/drafts/:id` | ✅ high | `apps\mesas\backend\src\routes\inbox\drafts.ts` | 157 |
| POST | `/api/v1/admin/import/drafts/:id/reparse` | ✅ high | `apps\mesas\backend\src\routes\inbox\drafts.ts` | 194 |
...
| GET | `/api/v1/notifications` | ✅ high | `apps\mesas\backend\src\routes\notifications.ts` | 10 |
| USE | `/api/v1/notifications` | ✅ high | `apps\mesas\backend\src\server.ts` | 124 |
| PATCH | `/api/v1/notifications/:id/read` | ✅ high | `apps\mesas\backend\src\routes\notifications.ts` | 55 |
| PATCH | `/api/v1/notifications/read-all` | ✅ high | `apps\mesas\backend\src\routes\notifications.ts` | 33 |
...
| POST | `/api/v1/scenario-suggestions` | ✅ high | `apps\mesas\backend\src\routes\scenarioSuggestions.ts` | 14 |
| USE | `/api/v1/scenario-suggestions` | ✅ high | `apps\mesas\backend\src\server.ts` | 122 |
| GET | `/api/v1/scenario-suggestions/mine` | ✅ high | `apps\mesas\backend\src\routes\scenarioSuggestions.ts` | 94 |
| GET | `/api/v1/scenarios` | ✅ high | `apps\mesas\backend\src\routes\scenarios.ts` | 30 |
| USE | `/api/v1/scenarios` | ✅ high | `apps\mesas\backend\src\server.ts` | 120 |
| GET | `/api/v1/scenarios/:id` | ✅ high | `apps\mesas\backend\src\routes\scenarios.ts` | 105 |
| POST | `/api/v1/scenarios/admin` | ✅ high | `apps\mesas\backend\src\routes\scenarios.ts` | 131 |
| DELETE | `/api/v1/scenarios/admin/:id` | ✅ high | `apps\mesas\backend\src\routes\scenarios.ts` | 233 |
| PUT | `/api/v1/scenarios/admin/:id` | ✅ high | `apps\mesas\backend\src\routes\scenarios.ts` | 175 |
...
| POST | `/api/v1/system-suggestions` | ✅ high | `apps\mesas\backend\src\routes\systemSuggestions.ts` | 14 |
| USE | `/api/v1/system-suggestions` | ✅ high | `apps\mesas\backend\src\server.ts` | 121 |
| GET | `/api/v1/system-suggestions/mine` | ✅ high | `apps\mesas\backend\src\routes\systemSuggestions.ts` | 102 |
...
| GET | `/api/v1/tables` | ✅ high | `apps\mesas\backend\src\routes\tables.ts` | 18 |
| USE | `/api/v1/tables` | ✅ high | `apps\mesas\backend\src\server.ts` | 118 |
| GET | `/api/v1/tables/:slug` | ✅ high | `apps\mesas\backend\src\routes\tables.ts` | 276 |
| POST | `/api/v1/tables/:slug/click` | ✅ high | `apps\mesas\backend\src\routes\tables.ts` | 518 |
| POST | `/api/v1/tables/:slug/view` | ✅ high | `apps\mesas\backend\src\routes\tables.ts` | 479 |
