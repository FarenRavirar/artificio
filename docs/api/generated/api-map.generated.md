...
| GET | `/api/admin/v1/feedback` | ✅ high | `apps/site/server/admin-api.ts` | 291 |
| DELETE | `/api/admin/v1/feedback/:id` | ✅ high | `apps/site/server/admin-api.ts` | 314 |
| PATCH | `/api/admin/v1/feedback/:id` | ✅ high | `apps/site/server/admin-api.ts` | 300 |
| GET | `/api/admin/v1/media` | ✅ high | `apps/site/server/admin-api.ts` | 214 |
| POST | `/api/admin/v1/media` | ✅ high | `apps/site/server/admin-api.ts` | 224 |
| DELETE | `/api/admin/v1/media/:id` | ✅ high | `apps/site/server/admin-api.ts` | 272 |
| PUT | `/api/admin/v1/media/:id` | ✅ high | `apps/site/server/admin-api.ts` | 262 |
| GET | `/api/admin/v1/pages` | ✅ high | `apps/site/server/admin-api.ts` | 131 |
| POST | `/api/admin/v1/pages` | ✅ high | `apps/site/server/admin-api.ts` | 141 |
| DELETE | `/api/admin/v1/pages/:id` | ✅ high | `apps/site/server/admin-api.ts` | 174 |
| GET | `/api/admin/v1/pages/:id` | ✅ high | `apps/site/server/admin-api.ts` | 134 |
| PUT | `/api/admin/v1/pages/:id` | ✅ high | `apps/site/server/admin-api.ts` | 147 |
| POST | `/api/admin/v1/pages/:id/status` | ✅ high | `apps/site/server/admin-api.ts` | 161 |
...
| DELETE | `/api/admin/v1/posts/:id` | ✅ high | `apps/site/server/admin-api.ts` | 120 |
| GET | `/api/admin/v1/posts/:id` | ✅ high | `apps/site/server/admin-api.ts` | 70 |
| PUT | `/api/admin/v1/posts/:id` | ✅ high | `apps/site/server/admin-api.ts` | 87 |
| POST | `/api/admin/v1/posts/:id/status` | ✅ high | `apps/site/server/admin-api.ts` | 106 |
| POST | `/api/admin/v1/preview` | ✅ high | `apps/site/server/admin-api.ts` | 281 |
| POST | `/api/admin/v1/rebuild` | ✅ high | `apps/site/server/admin-api.ts` | 325 |
| GET | `/api/admin/v1/rebuild/status` | ✅ high | `apps/site/server/admin-api.ts` | 334 |
| GET | `/api/admin/v1/redirects` | ✅ high | `apps/site/server/admin-api.ts` | 199 |
| POST | `/api/admin/v1/redirects` | ✅ high | `apps/site/server/admin-api.ts` | 200 |
| GET | `/api/admin/v1/slug-check` | ✅ high | `apps/site/server/admin-api.ts` | 47 |
| GET | `/api/admin/v1/taxonomies` | ✅ high | `apps/site/server/admin-api.ts` | 185 |
| POST | `/api/admin/v1/taxonomies` | ✅ high | `apps/site/server/admin-api.ts` | 188 |
