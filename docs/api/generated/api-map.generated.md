...
| GET | `/api/v1/community/appeals/:id` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 128 |
| POST | `/api/v1/community/comments/:id/reports` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 134 |
...
| GET | `/api/v1/community/moderation/cases/:id` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 163 |
| PATCH | `/api/v1/community/moderation/cases/:id/priority` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 172 |
| POST | `/api/v1/community/moderation/cases/:id/reopen` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 169 |
| POST | `/api/v1/community/moderation/cases/:id/resolution` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 166 |
| POST | `/api/v1/community/moderation/comments/:id/removal` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 157 |
| POST | `/api/v1/community/moderation/comments/:id/restore` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 160 |
| GET | `/api/v1/community/moderation/comments/:id/versions` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 154 |
| GET | `/api/v1/community/moderation/log` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 150 |
| GET | `/api/v1/community/moderation/queue` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 146 |
| GET | `/api/v1/community/moderation/sanctions` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 181 |
| POST | `/api/v1/community/moderation/sanctions` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 185 |
| DELETE | `/api/v1/community/moderation/sanctions/:id` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 188 |
| GET | `/api/v1/community/report-reasons` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 131 |
| GET | `/api/v1/community/reports` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 125 |
| DELETE | `/api/v1/community/reports/:id` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 137 |
