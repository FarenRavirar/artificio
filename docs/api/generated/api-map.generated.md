...
| GET | `/api/v1/community/appeals/:id` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 74 |
| POST | `/api/v1/community/comments/:id/reports` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 80 |
...
| POST | `/api/v1/community/decisions/:id/appeals` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 86 |
| GET | `/api/v1/community/moderation/appeals/:id` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 119 |
| POST | `/api/v1/community/moderation/appeals/:id/resolution` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 122 |
| GET | `/api/v1/community/moderation/cases/:id` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 107 |
| PATCH | `/api/v1/community/moderation/cases/:id/priority` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 116 |
| POST | `/api/v1/community/moderation/cases/:id/reopen` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 113 |
| POST | `/api/v1/community/moderation/cases/:id/resolution` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 110 |
| POST | `/api/v1/community/moderation/comments/:id/removal` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 101 |
| POST | `/api/v1/community/moderation/comments/:id/restore` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 104 |
| GET | `/api/v1/community/moderation/comments/:id/versions` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 98 |
| GET | `/api/v1/community/moderation/log` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 94 |
| GET | `/api/v1/community/moderation/queue` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 90 |
| GET | `/api/v1/community/moderation/sanctions` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 125 |
| POST | `/api/v1/community/moderation/sanctions` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 129 |
| DELETE | `/api/v1/community/moderation/sanctions/:id` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 132 |
| GET | `/api/v1/community/report-reasons` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 77 |
| GET | `/api/v1/community/reports` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 71 |
| DELETE | `/api/v1/community/reports/:id` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 83 |
...
| GET | `/api/v1/community/appeals/:id` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 112 |
| POST | `/api/v1/community/comments/:id/reports` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 118 |
...
| POST | `/api/v1/community/decisions/:id/appeals` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 124 |
| GET | `/api/v1/community/moderation/appeals/:id` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 159 |
| POST | `/api/v1/community/moderation/appeals/:id/resolution` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 162 |
| GET | `/api/v1/community/moderation/cases/:id` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 147 |
| PATCH | `/api/v1/community/moderation/cases/:id/priority` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 156 |
| POST | `/api/v1/community/moderation/cases/:id/reopen` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 153 |
| POST | `/api/v1/community/moderation/cases/:id/resolution` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 150 |
| POST | `/api/v1/community/moderation/comments/:id/removal` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 141 |
| POST | `/api/v1/community/moderation/comments/:id/restore` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 144 |
| GET | `/api/v1/community/moderation/comments/:id/versions` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 138 |
| GET | `/api/v1/community/moderation/log` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 134 |
| GET | `/api/v1/community/moderation/queue` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 130 |
| GET | `/api/v1/community/moderation/sanctions` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 165 |
| POST | `/api/v1/community/moderation/sanctions` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 169 |
| DELETE | `/api/v1/community/moderation/sanctions/:id` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 172 |
| GET | `/api/v1/community/report-reasons` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 115 |
| GET | `/api/v1/community/reports` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 109 |
| DELETE | `/api/v1/community/reports/:id` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 121 |
