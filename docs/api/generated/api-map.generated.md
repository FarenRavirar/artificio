...
| mesas | 262 | 262 | 0 | 0 | DELETE, GET, PATCH, POST, PUT, USE |
...
| POST | `/api/v1/admin/system-suggestions/:id/resolve` | ✅ high | `apps/downloads/backend/src/routes/systemSuggestionsAdmin.ts` | 317 |
...
| Método | Path | Confiança | Arquivo | Linha |
|--------|------|-----------|---------|------|
| USE | `/` | ✅ high | `apps/mesas/backend/src/server.ts` | 162 |
| USE | `/api/v1` | ✅ high | `apps/mesas/backend/src/server.ts` | 160 |
| USE | `/api/v1/admin` | ✅ high | `apps/mesas/backend/src/server.ts` | 124 |
| USE | `/api/v1/admin` | ✅ high | `apps/mesas/backend/src/server.ts` | 144 |
| USE | `/api/v1/admin` | ✅ high | `apps/mesas/backend/src/server.ts` | 145 |
| USE | `/api/v1/admin` | ✅ high | `apps/mesas/backend/src/server.ts` | 146 |
| USE | `/api/v1/admin` | ✅ high | `apps/mesas/backend/src/server.ts` | 149 |
| USE | `/api/v1/admin` | ✅ high | `apps/mesas/backend/src/server.ts` | 150 |
| USE | `/api/v1/admin` | ✅ high | `apps/mesas/backend/src/server.ts` | 151 |
| USE | `/api/v1/admin` | ✅ high | `apps/mesas/backend/src/server.ts` | 152 |
...
| USE | `/api/v1/admin/discord` | ✅ high | `apps/mesas/backend/src/server.ts` | 147 |
| USE | `/api/v1/admin/discord` | ✅ high | `apps/mesas/backend/src/routes/adminDiscordSync.ts` | 24 |
| USE | `/api/v1/admin/discord` | ✅ high | `apps/mesas/backend/src/routes/adminDiscordSync.ts` | 36 |
| USE | `/api/v1/admin/discord/automation` | ✅ high | `apps/mesas/backend/src/routes/adminDiscordSync.ts` | 40 |
...
| USE | `/api/v1/admin/discord/import-json` | ✅ high | `apps/mesas/backend/src/routes/adminDiscordSync.ts` | 37 |
| USE | `/api/v1/admin/discord/import-json` | ✅ high | `apps/mesas/backend/src/routes/adminDiscordSync.ts` | 38 |
...
| GET | `/api/v1/admin/discord/messages` | ✅ high | `apps/mesas/backend/src/routes/discord/messages.ts` | 70 |
...
| PATCH | `/api/v1/admin/discord/messages/:id` | ✅ high | `apps/mesas/backend/src/routes/discord/messages.ts` | 172 |
| POST | `/api/v1/admin/discord/messages/:id/diagnose-content` | ✅ high | `apps/mesas/backend/src/routes/discord/messages.ts` | 194 |
| POST | `/api/v1/admin/discord/messages/:id/parse` | ✅ high | `apps/mesas/backend/src/routes/discord/messageParse.ts` | 8 |
| DELETE | `/api/v1/admin/discord/messages/batch` | ✅ high | `apps/mesas/backend/src/routes/discord/messages.ts` | 141 |
| PATCH | `/api/v1/admin/discord/messages/batch` | ✅ high | `apps/mesas/backend/src/routes/discord/messages.ts` | 108 |
...
| USE | `/api/v1/admin/discord/metrics` | ✅ high | `apps/mesas/backend/src/routes/adminDiscordSync.ts` | 39 |
...
| USE | `/api/v1/admin/import` | ✅ high | `apps/mesas/backend/src/server.ts` | 148 |
...
| USE | `/api/v1/admin/setting-suggestions` | ✅ high | `apps/mesas/backend/src/server.ts` | 156 |
...
| GET | `/api/v1/admin/system-suggestions` | ✅ high | `apps/mesas/backend/src/routes/systemSuggestionsAdmin.ts` | 368 |
| PATCH | `/api/v1/admin/system-suggestions/:id/approve` | ✅ high | `apps/mesas/backend/src/routes/systemSuggestionsAdmin.ts` | 503 |
| GET | `/api/v1/admin/system-suggestions/:id/candidates` | ✅ high | `apps/mesas/backend/src/routes/systemSuggestionsAdmin.ts` | 372 |
| PATCH | `/api/v1/admin/system-suggestions/:id/reject` | ✅ high | `apps/mesas/backend/src/routes/systemSuggestionsAdmin.ts` | 549 |
| POST | `/api/v1/admin/system-suggestions/:id/resolve` | ✅ high | `apps/mesas/backend/src/routes/systemSuggestionsAdmin.ts` | 1202 |
...
| USE | `/api/v1/auth` | ✅ high | `apps/mesas/backend/src/server.ts` | 118 |
...
| USE | `/api/v1/changelog` | ✅ high | `apps/mesas/backend/src/server.ts` | 159 |
| GET | `/api/v1/communication-platforms` | ✅ high | `apps/mesas/backend/src/routes/communicationPlatforms.ts` | 66 |
| USE | `/api/v1/communication-platforms` | ✅ high | `apps/mesas/backend/src/server.ts` | 158 |
| GET | `/api/v1/communication-platforms/admin` | ✅ high | `apps/mesas/backend/src/routes/communicationPlatforms.ts` | 84 |
| POST | `/api/v1/communication-platforms/admin` | ✅ high | `apps/mesas/backend/src/routes/communicationPlatforms.ts` | 101 |
| DELETE | `/api/v1/communication-platforms/admin/:id` | ✅ high | `apps/mesas/backend/src/routes/communicationPlatforms.ts` | 272 |
| PUT | `/api/v1/communication-platforms/admin/:id` | ✅ high | `apps/mesas/backend/src/routes/communicationPlatforms.ts` | 188 |
| USE | `/api/v1/community` | ✅ high | `apps/mesas/backend/src/server.ts` | 143 |
...
| USE | `/api/v1/community/conversation` | ✅ high | `apps/mesas/backend/src/server.ts` | 140 |
...
| USE | `/api/v1/dev-feedback` | ✅ high | `apps/mesas/backend/src/server.ts` | 130 |
| USE | `/api/v1/gm` | ✅ high | `apps/mesas/backend/src/server.ts` | 153 |
| USE | `/api/v1/gm` | ✅ high | `apps/mesas/backend/src/server.ts` | 154 |
| GET | `/api/v1/gm/insights` | ✅ high | `apps/mesas/backend/src/routes/gmPanel.ts` | 1903 |
| GET | `/api/v1/gm/me` | ✅ high | `apps/mesas/backend/src/routes/gmPanel.ts` | 669 |
| POST | `/api/v1/gm/parse-preview` | ✅ high | `apps/mesas/backend/src/routes/gmPanel.ts` | 857 |
| GET | `/api/v1/gm/perfis/:slug` | ✅ high | `apps/mesas/backend/src/routes/gm.ts` | 118 |
| POST | `/api/v1/gm/perfis/:slug/contact` | ✅ high | `apps/mesas/backend/src/routes/gm.ts` | 605 |
| POST | `/api/v1/gm/perfis/:slug/contact-click` | ✅ high | `apps/mesas/backend/src/routes/gm.ts` | 677 |
| GET | `/api/v1/gm/perfis/:slug/insights` | ✅ high | `apps/mesas/backend/src/routes/gm.ts` | 552 |
| GET | `/api/v1/gm/perfis/:slug/reviews` | ✅ high | `apps/mesas/backend/src/routes/gm.ts` | 723 |
| POST | `/api/v1/gm/perfis/:slug/reviews` | ✅ high | `apps/mesas/backend/src/routes/gm.ts` | 771 |
| POST | `/api/v1/gm/perfis/:slug/view` | ✅ high | `apps/mesas/backend/src/routes/gm.ts` | 484 |
| POST | `/api/v1/gm/profile` | ✅ high | `apps/mesas/backend/src/routes/gmPanel.ts` | 257 |
| PUT | `/api/v1/gm/profile` | ✅ high | `apps/mesas/backend/src/routes/gmPanel.ts` | 418 |
| POST | `/api/v1/gm/profile/bio-suggestions` | ✅ high | `apps/mesas/backend/src/routes/gmPanel.ts` | 624 |
| GET | `/api/v1/gm/tables` | ✅ high | `apps/mesas/backend/src/routes/gmPanel.ts` | 1335 |
| POST | `/api/v1/gm/tables` | ✅ high | `apps/mesas/backend/src/routes/gmPanel.ts` | 922 |
| DELETE | `/api/v1/gm/tables/:id` | ✅ high | `apps/mesas/backend/src/routes/gmPanel.ts` | 1695 |
| GET | `/api/v1/gm/tables/:id` | ✅ high | `apps/mesas/backend/src/routes/gmPanel.ts` | 736 |
| PUT | `/api/v1/gm/tables/:id` | ✅ high | `apps/mesas/backend/src/routes/gmPanel.ts` | 1036 |
| PATCH | `/api/v1/gm/tables/:id/archive` | ✅ high | `apps/mesas/backend/src/routes/gmPanel.ts` | 1623 |
| POST | `/api/v1/gm/tables/:id/click` | ✅ high | `apps/mesas/backend/src/routes/gmPanel.ts` | 1794 |
| POST | `/api/v1/gm/tables/:id/contact` | ✅ high | `apps/mesas/backend/src/routes/gmPanel.ts` | 1830 |
| POST | `/api/v1/gm/tables/:id/favorite` | ✅ high | `apps/mesas/backend/src/routes/gmPanel.ts` | 1866 |
| PATCH | `/api/v1/gm/tables/:id/status` | ✅ high | `apps/mesas/backend/src/routes/gmPanel.ts` | 1487 |
| POST | `/api/v1/gm/tables/:slug/view` | ✅ high | `apps/mesas/backend/src/routes/gmPanel.ts` | 1752 |
| GET | `/api/v1/health` | ✅ high | `apps/mesas/backend/src/server.ts` | 99 |
| GET | `/api/v1/me` | ✅ high | `apps/mesas/backend/src/routes/me.ts` | 27 |
| USE | `/api/v1/me` | ✅ high | `apps/mesas/backend/src/server.ts` | 121 |
...
| USE | `/api/v1/profile` | ✅ high | `apps/mesas/backend/src/server.ts` | 122 |
| USE | `/api/v1/profile` | ✅ high | `apps/mesas/backend/src/server.ts` | 123 |
| PATCH | `/api/v1/profile/gm` | ✅ high | `apps/mesas/backend/src/routes/profile.ts` | 211 |
...
| GET | `/api/v1/profile/me` | ✅ high | `apps/mesas/backend/src/routes/profile.ts` | 19 |
| PATCH | `/api/v1/profile/me` | ✅ high | `apps/mesas/backend/src/routes/profile.ts` | 39 |
| DELETE | `/api/v1/profile/me/connect/discord` | ✅ high | `apps/mesas/backend/src/routes/profile.ts` | 325 |
| POST | `/api/v1/profile/me/connect/discord` | ✅ high | `apps/mesas/backend/src/routes/profile.ts` | 299 |
| GET | `/api/v1/profile/me/discord` | ✅ high | `apps/mesas/backend/src/routes/profile.ts` | 279 |
| PATCH | `/api/v1/profile/me/gm` | ✅ high | `apps/mesas/backend/src/routes/profile.ts` | 209 |
| POST | `/api/v1/profile/me/google-picture` | ✅ high | `apps/mesas/backend/src/routes/profile.ts` | 345 |
| PATCH | `/api/v1/profile/me/player` | ✅ high | `apps/mesas/backend/src/routes/profile.ts` | 145 |
| PATCH | `/api/v1/profile/me/profile` | ✅ high | `apps/mesas/backend/src/routes/profile.ts` | 81 |
| PATCH | `/api/v1/profile/player` | ✅ high | `apps/mesas/backend/src/routes/profile.ts` | 147 |
| POST | `/api/v1/profile/systems` | ✅ high | `apps/mesas/backend/src/routes/profile.ts` | 214 |
| DELETE | `/api/v1/profile/systems/:id` | ✅ high | `apps/mesas/backend/src/routes/profile.ts` | 257 |
| POST | `/api/v1/scenario-suggestions` | ✅ high | `apps/mesas/backend/src/routes/scenarioSuggestions.ts` | 16 |
| USE | `/api/v1/scenario-suggestions` | ✅ high | `apps/mesas/backend/src/server.ts` | 129 |
...
| USE | `/api/v1/scenarios` | ✅ high | `apps/mesas/backend/src/server.ts` | 127 |
...
| USE | `/api/v1/settings` | ✅ high | `apps/mesas/backend/src/server.ts` | 155 |
...
| USE | `/api/v1/system-suggestions` | ✅ high | `apps/mesas/backend/src/server.ts` | 128 |
| GET | `/api/v1/system-suggestions/mine` | ✅ high | `apps/mesas/backend/src/routes/systemSuggestions.ts` | 189 |
| GET | `/api/v1/systems` | ✅ high | `apps/mesas/backend/src/routes/systems.ts` | 29 |
| USE | `/api/v1/systems` | ✅ high | `apps/mesas/backend/src/server.ts` | 126 |
| POST | `/api/v1/systems/admin` | ✅ high | `apps/mesas/backend/src/routes/systems.ts` | 143 |
...
| GET | `/api/v1/tables` | ✅ high | `apps/mesas/backend/src/routes/tables.ts` | 159 |
| USE | `/api/v1/tables` | ✅ high | `apps/mesas/backend/src/server.ts` | 125 |
| GET | `/api/v1/tables/:slug` | ✅ high | `apps/mesas/backend/src/routes/tables.ts` | 843 |
| POST | `/api/v1/tables/:slug/click` | ✅ high | `apps/mesas/backend/src/routes/tables.ts` | 1117 |
| GET | `/api/v1/tables/:slug/favorite` | ✅ high | `apps/mesas/backend/src/routes/tables.ts` | 1183 |
| POST | `/api/v1/tables/:slug/favorite` | ✅ high | `apps/mesas/backend/src/routes/tables.ts` | 1215 |
| POST | `/api/v1/tables/:slug/report` | ✅ high | `apps/mesas/backend/src/routes/tables.ts` | 1281 |
| POST | `/api/v1/tables/:slug/view` | ✅ high | `apps/mesas/backend/src/routes/tables.ts` | 1077 |
| GET | `/api/v1/tables/schedule-facets` | ✅ high | `apps/mesas/backend/src/routes/tables.ts` | 656 |
| GET | `/api/v1/tables/style-facets` | ✅ high | `apps/mesas/backend/src/routes/tables.ts` | 614 |
...
| USE | `/api/v1/vtt-platforms` | ✅ high | `apps/mesas/backend/src/server.ts` | 157 |
| GET | `/api/v1/vtt-platforms/admin` | ✅ high | `apps/mesas/backend/src/routes/vttPlatforms.ts` | 278 |
| POST | `/api/v1/vtt-platforms/admin` | ✅ high | `apps/mesas/backend/src/routes/vttPlatforms.ts` | 310 |
| DELETE | `/api/v1/vtt-platforms/admin/:id` | ✅ high | `apps/mesas/backend/src/routes/vttPlatforms.ts` | 571 |
| PUT | `/api/v1/vtt-platforms/admin/:id` | ✅ high | `apps/mesas/backend/src/routes/vttPlatforms.ts` | 429 |
| POST | `/api/v1/vtt-platforms/suggest` | ✅ high | `apps/mesas/backend/src/routes/vttPlatforms.ts` | 167 |
| USE | `/auth` | ✅ high | `apps/mesas/backend/src/server.ts` | 119 |
| USE | `/auth` | ✅ high | `apps/mesas/backend/src/server.ts` | 120 |
...
| USE | `/og` | ✅ high | `apps/mesas/backend/src/server.ts` | 161 |
...
| USE | `/api/admin/v1` | ✅ high | `apps/site/server/server.ts` | 267 |
| USE | `/api/admin/v1/catalog` | ✅ high | `apps/site/server/server.ts` | 264 |
...
| USE | `/api/admin/v1/catalog/material-types` | ✅ high | `apps/site/server/server.ts` | 265 |
...
| GET | `/api/admin/v1/feedback` | ✅ high | `apps/site/server/admin-api.ts` | 295 |
| DELETE | `/api/admin/v1/feedback/:id` | ✅ high | `apps/site/server/admin-api.ts` | 318 |
| PATCH | `/api/admin/v1/feedback/:id` | ✅ high | `apps/site/server/admin-api.ts` | 304 |
| GET | `/api/admin/v1/media` | ✅ high | `apps/site/server/admin-api.ts` | 218 |
| POST | `/api/admin/v1/media` | ✅ high | `apps/site/server/admin-api.ts` | 228 |
| DELETE | `/api/admin/v1/media/:id` | ✅ high | `apps/site/server/admin-api.ts` | 276 |
| PUT | `/api/admin/v1/media/:id` | ✅ high | `apps/site/server/admin-api.ts` | 266 |
| GET | `/api/admin/v1/pages` | ✅ high | `apps/site/server/admin-api.ts` | 134 |
| POST | `/api/admin/v1/pages` | ✅ high | `apps/site/server/admin-api.ts` | 144 |
| DELETE | `/api/admin/v1/pages/:id` | ✅ high | `apps/site/server/admin-api.ts` | 178 |
| GET | `/api/admin/v1/pages/:id` | ✅ high | `apps/site/server/admin-api.ts` | 137 |
| PUT | `/api/admin/v1/pages/:id` | ✅ high | `apps/site/server/admin-api.ts` | 151 |
| POST | `/api/admin/v1/pages/:id/status` | ✅ high | `apps/site/server/admin-api.ts` | 165 |
| GET | `/api/admin/v1/posts` | ✅ high | `apps/site/server/admin-api.ts` | 61 |
| POST | `/api/admin/v1/posts` | ✅ high | `apps/site/server/admin-api.ts` | 78 |
| DELETE | `/api/admin/v1/posts/:id` | ✅ high | `apps/site/server/admin-api.ts` | 123 |
| GET | `/api/admin/v1/posts/:id` | ✅ high | `apps/site/server/admin-api.ts` | 70 |
| PUT | `/api/admin/v1/posts/:id` | ✅ high | `apps/site/server/admin-api.ts` | 90 |
| POST | `/api/admin/v1/posts/:id/status` | ✅ high | `apps/site/server/admin-api.ts` | 109 |
| POST | `/api/admin/v1/preview` | ✅ high | `apps/site/server/admin-api.ts` | 285 |
| POST | `/api/admin/v1/rebuild` | ✅ high | `apps/site/server/admin-api.ts` | 329 |
| GET | `/api/admin/v1/rebuild/status` | ✅ high | `apps/site/server/admin-api.ts` | 338 |
| GET | `/api/admin/v1/redirects` | ✅ high | `apps/site/server/admin-api.ts` | 203 |
| POST | `/api/admin/v1/redirects` | ✅ high | `apps/site/server/admin-api.ts` | 204 |
| GET | `/api/admin/v1/slug-check` | ✅ high | `apps/site/server/admin-api.ts` | 47 |
| GET | `/api/admin/v1/taxonomies` | ✅ high | `apps/site/server/admin-api.ts` | 189 |
| POST | `/api/admin/v1/taxonomies` | ✅ high | `apps/site/server/admin-api.ts` | 192 |
| USE | `/api/catalog/v1` | ✅ high | `apps/site/server/server.ts` | 239 |
...
| POST | `/api/feedback` | ✅ high | `apps/site/server/server.ts` | 193 |
...
| USE | `/api/v1/community/conversation` | ✅ high | `apps/site/server/server.ts` | 248 |
...
| USE | `/api/v1/community/moderation` | ✅ high | `apps/site/server/server.ts` | 255 |
...
| GET | `/healthz` | ✅ high | `apps/site/server/server.ts` | 136 |
| USE | `/uploads` | ✅ high | `apps/site/server/server.ts` | 271 |
