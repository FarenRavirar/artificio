...
| GET | `/api/v1/community/appeals/:id` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 79 |
| POST | `/api/v1/community/comments/:id/reports` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 85 |
...
| POST | `/api/v1/community/decisions/:id/appeals` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 91 |
| GET | `/api/v1/community/moderation/appeals/:id` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 124 |
| POST | `/api/v1/community/moderation/appeals/:id/resolution` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 127 |
| GET | `/api/v1/community/moderation/cases/:id` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 112 |
| PATCH | `/api/v1/community/moderation/cases/:id/priority` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 121 |
| POST | `/api/v1/community/moderation/cases/:id/reopen` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 118 |
| POST | `/api/v1/community/moderation/cases/:id/resolution` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 115 |
| POST | `/api/v1/community/moderation/comments/:id/removal` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 106 |
| POST | `/api/v1/community/moderation/comments/:id/restore` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 109 |
| GET | `/api/v1/community/moderation/comments/:id/versions` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 103 |
| GET | `/api/v1/community/moderation/log` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 99 |
| GET | `/api/v1/community/moderation/queue` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 95 |
| GET | `/api/v1/community/moderation/sanctions` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 130 |
| POST | `/api/v1/community/moderation/sanctions` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 134 |
| DELETE | `/api/v1/community/moderation/sanctions/:id` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 137 |
| GET | `/api/v1/community/report-reasons` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 82 |
| GET | `/api/v1/community/reports` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 76 |
| DELETE | `/api/v1/community/reports/:id` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 88 |
...
| GET | `/api/v1/community/appeals/:id` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 118 |
| POST | `/api/v1/community/comments/:id/reports` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 124 |
| GET | `/api/v1/community/conversation` | ✅ high | `apps/mesas/backend/src/routes/communityComments.ts` | 140 |
| POST | `/api/v1/community/conversation` | ✅ high | `apps/mesas/backend/src/routes/communityComments.ts` | 181 |
| USE | `/api/v1/community/conversation` | ✅ high | `apps/mesas/backend/src/server.ts` | 135 |
| DELETE | `/api/v1/community/conversation/:id` | ✅ high | `apps/mesas/backend/src/routes/communityComments.ts` | 222 |
| PATCH | `/api/v1/community/conversation/:id` | ✅ high | `apps/mesas/backend/src/routes/communityComments.ts` | 215 |
| POST | `/api/v1/community/conversation/:id/replies` | ✅ high | `apps/mesas/backend/src/routes/communityComments.ts` | 194 |
| PUT | `/api/v1/community/conversation/:id/vote` | ✅ high | `apps/mesas/backend/src/routes/communityComments.ts` | 273 |
| POST | `/api/v1/community/decisions/:id/appeals` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 130 |
| GET | `/api/v1/community/moderation/appeals/:id` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 165 |
| POST | `/api/v1/community/moderation/appeals/:id/resolution` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 168 |
| GET | `/api/v1/community/moderation/cases/:id` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 153 |
| PATCH | `/api/v1/community/moderation/cases/:id/priority` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 162 |
| POST | `/api/v1/community/moderation/cases/:id/reopen` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 159 |
| POST | `/api/v1/community/moderation/cases/:id/resolution` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 156 |
| POST | `/api/v1/community/moderation/comments/:id/removal` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 147 |
| POST | `/api/v1/community/moderation/comments/:id/restore` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 150 |
| GET | `/api/v1/community/moderation/comments/:id/versions` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 144 |
| GET | `/api/v1/community/moderation/log` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 140 |
| GET | `/api/v1/community/moderation/queue` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 136 |
| GET | `/api/v1/community/moderation/sanctions` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 171 |
| POST | `/api/v1/community/moderation/sanctions` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 175 |
| DELETE | `/api/v1/community/moderation/sanctions/:id` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 178 |
| GET | `/api/v1/community/report-reasons` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 121 |
| GET | `/api/v1/community/reports` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 115 |
| DELETE | `/api/v1/community/reports/:id` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 127 |
