...
| GET | `/api/v1/community/moderation/cases/:id` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 205 |
| PATCH | `/api/v1/community/moderation/cases/:id/priority` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 214 |
| POST | `/api/v1/community/moderation/cases/:id/reopen` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 211 |
| POST | `/api/v1/community/moderation/cases/:id/resolution` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 208 |
| POST | `/api/v1/community/moderation/comments/:id/removal` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 199 |
| POST | `/api/v1/community/moderation/comments/:id/restore` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 202 |
| GET | `/api/v1/community/moderation/comments/:id/versions` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 196 |
| GET | `/api/v1/community/moderation/log` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 192 |
| GET | `/api/v1/community/moderation/queue` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 188 |
| GET | `/api/v1/community/moderation/sanctions` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 223 |
| POST | `/api/v1/community/moderation/sanctions` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 227 |
| DELETE | `/api/v1/community/moderation/sanctions/:id` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 230 |
| GET | `/api/v1/community/report-reasons` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 175 |
| GET | `/api/v1/community/reports` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 169 |
| DELETE | `/api/v1/community/reports/:id` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 181 |
...
| GET | `/api/v1/community/appeals/:id` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 207 |
| POST | `/api/v1/community/comments/:id/reports` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 213 |
| GET | `/api/v1/community/conversation` | ✅ high | `apps/mesas/backend/src/routes/communityComments.ts` | 218 |
| POST | `/api/v1/community/conversation` | ✅ high | `apps/mesas/backend/src/routes/communityComments.ts` | 259 |
| USE | `/api/v1/community/conversation` | ✅ high | `apps/mesas/backend/src/server.ts` | 135 |
| DELETE | `/api/v1/community/conversation/:id` | ✅ high | `apps/mesas/backend/src/routes/communityComments.ts` | 300 |
| PATCH | `/api/v1/community/conversation/:id` | ✅ high | `apps/mesas/backend/src/routes/communityComments.ts` | 293 |
| POST | `/api/v1/community/conversation/:id/replies` | ✅ high | `apps/mesas/backend/src/routes/communityComments.ts` | 272 |
| PUT | `/api/v1/community/conversation/:id/vote` | ✅ high | `apps/mesas/backend/src/routes/communityComments.ts` | 307 |
| POST | `/api/v1/community/decisions/:id/appeals` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 219 |
| GET | `/api/v1/community/moderation/appeals/:id` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 254 |
| POST | `/api/v1/community/moderation/appeals/:id/resolution` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 257 |
| GET | `/api/v1/community/moderation/cases/:id` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 242 |
| PATCH | `/api/v1/community/moderation/cases/:id/priority` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 251 |
| POST | `/api/v1/community/moderation/cases/:id/reopen` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 248 |
| POST | `/api/v1/community/moderation/cases/:id/resolution` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 245 |
| POST | `/api/v1/community/moderation/comments/:id/removal` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 236 |
| POST | `/api/v1/community/moderation/comments/:id/restore` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 239 |
| GET | `/api/v1/community/moderation/comments/:id/versions` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 233 |
| GET | `/api/v1/community/moderation/log` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 229 |
| GET | `/api/v1/community/moderation/queue` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 225 |
| GET | `/api/v1/community/moderation/sanctions` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 260 |
| POST | `/api/v1/community/moderation/sanctions` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 264 |
| DELETE | `/api/v1/community/moderation/sanctions/:id` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 267 |
| GET | `/api/v1/community/report-reasons` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 210 |
| GET | `/api/v1/community/reports` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 204 |
| DELETE | `/api/v1/community/reports/:id` | ✅ high | `apps/mesas/backend/src/routes/communityModeration.ts` | 216 |
