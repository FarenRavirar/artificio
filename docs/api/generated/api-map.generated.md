...
| downloads | 127 | 127 | 0 | 0 | DELETE, GET, PATCH, POST, PUT, USE |
...
| USE | `/api/v1/admin` | ✅ high | `apps/downloads/backend/src/server.ts` | 122 |
...
| USE | `/api/v1/admin/email-log` | ✅ high | `apps/downloads/backend/src/server.ts` | 124 |
...
| USE | `/api/v1/admin/material-type-suggestions` | ✅ high | `apps/downloads/backend/src/server.ts` | 128 |
...
| USE | `/api/v1/admin/rejection-categories` | ✅ high | `apps/downloads/backend/src/server.ts` | 123 |
...
| USE | `/api/v1/admin/scraper` | ✅ high | `apps/downloads/backend/src/server.ts` | 125 |
...
| USE | `/api/v1/admin/system-suggestions` | ✅ high | `apps/downloads/backend/src/server.ts` | 127 |
...
| USE | `/api/v1/changelog` | ✅ high | `apps/downloads/backend/src/server.ts` | 129 |
...
| USE | `/api/v1/collections` | ✅ high | `apps/downloads/backend/src/server.ts` | 118 |
...
| USE | `/api/v1/comments` | ✅ high | `apps/downloads/backend/src/server.ts` | 112 |
| GET | `/api/v1/comments/:materialId` | ✅ high | `apps/downloads/backend/src/routes/comments.ts` | 55 |
| USE | `/api/v1/community` | ✅ high | `apps/downloads/backend/src/server.ts` | 121 |
| GET | `/api/v1/community/appeals/:id` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 140 |
| POST | `/api/v1/community/comments/:id/reports` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 146 |
| POST | `/api/v1/community/decisions/:id/appeals` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 152 |
| GET | `/api/v1/community/moderation/appeals/:id` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 185 |
| POST | `/api/v1/community/moderation/appeals/:id/resolution` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 188 |
| GET | `/api/v1/community/moderation/cases/:id` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 173 |
| PATCH | `/api/v1/community/moderation/cases/:id/priority` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 182 |
| POST | `/api/v1/community/moderation/cases/:id/reopen` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 179 |
| POST | `/api/v1/community/moderation/cases/:id/resolution` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 176 |
| POST | `/api/v1/community/moderation/comments/:id/removal` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 167 |
| POST | `/api/v1/community/moderation/comments/:id/restore` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 170 |
| GET | `/api/v1/community/moderation/comments/:id/versions` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 164 |
| GET | `/api/v1/community/moderation/log` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 160 |
| GET | `/api/v1/community/moderation/queue` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 156 |
| GET | `/api/v1/community/moderation/sanctions` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 191 |
| POST | `/api/v1/community/moderation/sanctions` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 195 |
| DELETE | `/api/v1/community/moderation/sanctions/:id` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 198 |
| GET | `/api/v1/community/report-reasons` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 143 |
| GET | `/api/v1/community/reports` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 137 |
| DELETE | `/api/v1/community/reports/:id` | ✅ high | `apps/downloads/backend/src/routes/communityModeration.ts` | 149 |
| USE | `/api/v1/creators` | ✅ high | `apps/downloads/backend/src/server.ts` | 113 |
...
| USE | `/api/v1/destinations` | ✅ high | `apps/downloads/backend/src/server.ts` | 114 |
...
| USE | `/api/v1/downloads` | ✅ high | `apps/downloads/backend/src/server.ts` | 115 |
...
| USE | `/api/v1/favorites` | ✅ high | `apps/downloads/backend/src/server.ts` | 117 |
| DELETE | `/api/v1/favorites/:materialId` | ✅ high | `apps/downloads/backend/src/routes/favorites.ts` | 52 |
| GET | `/api/v1/health` | ✅ high | `apps/downloads/backend/src/server.ts` | 88 |
| USE | `/api/v1/material-metadata` | ✅ high | `apps/downloads/backend/src/server.ts` | 109 |
...
| USE | `/api/v1/moderation` | ✅ high | `apps/downloads/backend/src/server.ts` | 110 |
...
| USE | `/api/v1/notifications` | ✅ high | `apps/downloads/backend/src/server.ts` | 120 |
...
| USE | `/api/v1/organizations` | ✅ high | `apps/downloads/backend/src/server.ts` | 119 |
...
| USE | `/api/v1/ratings` | ✅ high | `apps/downloads/backend/src/server.ts` | 116 |
...
| USE | `/api/v1/reports` | ✅ high | `apps/downloads/backend/src/server.ts` | 111 |
...
| USE | `/api/v1/system-suggestions` | ✅ high | `apps/downloads/backend/src/server.ts` | 126 |
