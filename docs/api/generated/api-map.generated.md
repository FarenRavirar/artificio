...
| Método | Path | Confiança | Arquivo | Linha |
|--------|------|-----------|---------|------|
| USE | `/api/v1/admin` | ✅ high | `apps/downloads/backend/src/server.ts` | 108 |
...
| USE | `/api/v1/admin/email-log` | ✅ high | `apps/downloads/backend/src/server.ts` | 110 |
...
| USE | `/api/v1/admin/material-type-suggestions` | ✅ high | `apps/downloads/backend/src/server.ts` | 114 |
...
| USE | `/api/v1/admin/rejection-categories` | ✅ high | `apps/downloads/backend/src/server.ts` | 109 |
...
| USE | `/api/v1/admin/scraper` | ✅ high | `apps/downloads/backend/src/server.ts` | 111 |
...
| USE | `/api/v1/admin/system-suggestions` | ✅ high | `apps/downloads/backend/src/server.ts` | 113 |
...
| USE | `/api/v1/changelog` | ✅ high | `apps/downloads/backend/src/server.ts` | 115 |
...
| USE | `/api/v1/collections` | ✅ high | `apps/downloads/backend/src/server.ts` | 105 |
...
| USE | `/api/v1/comments` | ✅ high | `apps/downloads/backend/src/server.ts` | 99 |
...
| USE | `/api/v1/creators` | ✅ high | `apps/downloads/backend/src/server.ts` | 100 |
...
| USE | `/api/v1/destinations` | ✅ high | `apps/downloads/backend/src/server.ts` | 101 |
...
| USE | `/api/v1/downloads` | ✅ high | `apps/downloads/backend/src/server.ts` | 102 |
...
| USE | `/api/v1/favorites` | ✅ high | `apps/downloads/backend/src/server.ts` | 104 |
...
| USE | `/api/v1/material-metadata` | ✅ high | `apps/downloads/backend/src/server.ts` | 96 |
...
| USE | `/api/v1/materials` | ✅ high | `apps/downloads/backend/src/server.ts` | 94 |
| USE | `/api/v1/materials` | ✅ high | `apps/downloads/backend/src/server.ts` | 95 |
...
| USE | `/api/v1/moderation` | ✅ high | `apps/downloads/backend/src/server.ts` | 97 |
...
| USE | `/api/v1/notifications` | ✅ high | `apps/downloads/backend/src/server.ts` | 107 |
...
| USE | `/api/v1/organizations` | ✅ high | `apps/downloads/backend/src/server.ts` | 106 |
...
| USE | `/api/v1/ratings` | ✅ high | `apps/downloads/backend/src/server.ts` | 103 |
...
| USE | `/api/v1/reports` | ✅ high | `apps/downloads/backend/src/server.ts` | 98 |
...
| USE | `/api/v1/system-suggestions` | ✅ high | `apps/downloads/backend/src/server.ts` | 112 |
