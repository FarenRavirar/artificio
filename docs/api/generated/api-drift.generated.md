...
| GET | `/api/v1/admin/scraper/platforms` | 🕳️ UNUSED_ROUTE | ✅ | ❌ | 🆕 Novo (não bloqueante) |
...
| GET | `/api/v1/community/moderation/log` | 🕳️ UNUSED_ROUTE | ✅ | ❌ | 🆕 Novo (não bloqueante) |
| GET | `/api/v1/community/moderation/queue` | 🕳️ UNUSED_ROUTE | ✅ | ❌ | 🆕 Novo (não bloqueante) |
| GET | `/api/v1/community/moderation/sanctions` | 🕳️ UNUSED_ROUTE | ✅ | ❌ | 🆕 Novo (não bloqueante) |
| GET | `/api/v1/community/report-reasons` | 👻 ORPHAN_SUSPECT | ✅ | ❌ | 🆕 Novo (não bloqueante) |
...
| GET | `/api/v1/health` | ✅ OK | ✅ | ✅ | 🆕 Novo (não bloqueante) |
...
| POST | `/api/v1/admin/scraper/parse-html` | 🕳️ UNUSED_ROUTE | ✅ | ❌ | 🆕 Novo (não bloqueante) |
| POST | `/api/v1/admin/scraper/platforms` | 🕳️ UNUSED_ROUTE | ✅ | ❌ | 🆕 Novo (não bloqueante) |
...
| POST | `/api/v1/community/moderation/cases/:id/resolution` | 🕳️ UNUSED_ROUTE | ✅ | ❌ | 🆕 Novo (não bloqueante) |
| POST | `/api/v1/community/moderation/comments/:id/removal` | 🕳️ UNUSED_ROUTE | ✅ | ❌ | 🆕 Novo (não bloqueante) |
| POST | `/api/v1/community/moderation/comments/:id/restore` | 🕳️ UNUSED_ROUTE | ✅ | ❌ | 🆕 Novo (não bloqueante) |
| POST | `/api/v1/community/moderation/sanctions` | 🕳️ UNUSED_ROUTE | ✅ | ❌ | 🆕 Novo (não bloqueante) |
...
| DELETE | `/api/v1/admin/discord/messages/batch` | ✅ OK | ✅ | ✅ | 🆕 Novo (não bloqueante) |
| DELETE | `/api/v1/admin/discord/role-mappings/:id` | ✅ OK | ✅ | ✅ | 🆕 Novo (não bloqueante) |
...
| GET | `/api/v1/admin/discord/role-mappings` | ✅ OK | ✅ | ✅ | 🆕 Novo (não bloqueante) |
...
| GET | `/api/v1/tables/schedule-facets` | ✅ OK | ✅ | ✅ | 🆕 Novo (não bloqueante) |
...
| PATCH | `/api/v1/admin/discord/role-mappings/:id` | ✅ OK | ✅ | ✅ | 🆕 Novo (não bloqueante) |
...
| PATCH | `/api/v1/profile/gm` | 👻 ORPHAN_SUSPECT | ✅ | ❌ | 🆕 Novo (não bloqueante) |
...
| POST | `/api/v1/admin/discord/drafts/:id/restore` | 🕳️ UNUSED_ROUTE | ✅ | ❌ | 🆕 Novo (não bloqueante) |
...
| POST | `/api/v1/admin/import/drafts/:id/restore` | ✅ OK | ✅ | ✅ | 🆕 Novo (não bloqueante) |
...
| POST | `/api/v1/gm/profile/bio-suggestions` | ✅ OK | ✅ | ✅ | 🆕 Novo (não bloqueante) |
...
| POST | `/api/v1/vtt-platforms/suggest` | ✅ OK | ✅ | ✅ | 🆕 Novo (não bloqueante) |
...
| GET | `/api/admin/v1/catalog/snapshot` | 🕳️ UNUSED_ROUTE | ✅ | ❌ | 🆕 Novo (não bloqueante) |
| GET | `/api/admin/v1/catalog/systems` | 🕳️ UNUSED_ROUTE | ✅ | ❌ | 🆕 Novo (não bloqueante) |
| GET | `/api/admin/v1/feedback` | 🕳️ UNUSED_ROUTE | ✅ | ❌ | 🆕 Novo (não bloqueante) |
| GET | `/api/admin/v1/media` | 🕳️ UNUSED_ROUTE | ✅ | ❌ | 🆕 Novo (não bloqueante) |
| GET | `/api/admin/v1/pages` | 🕳️ UNUSED_ROUTE | ✅ | ❌ | 🆕 Novo (não bloqueante) |
| GET | `/api/admin/v1/pages/:id` | ✅ OK | ✅ | ✅ | 🆕 Novo (não bloqueante) |
| GET | `/api/admin/v1/posts` | 🕳️ UNUSED_ROUTE | ✅ | ❌ | 🆕 Novo (não bloqueante) |
| GET | `/api/admin/v1/posts/:id` | ✅ OK | ✅ | ✅ | 🆕 Novo (não bloqueante) |
| GET | `/api/admin/v1/redirects` | 🕳️ UNUSED_ROUTE | ✅ | ❌ | 🆕 Novo (não bloqueante) |
| GET | `/api/admin/v1/slug-check` | 🕳️ UNUSED_ROUTE | ✅ | ❌ | 🆕 Novo (não bloqueante) |
| GET | `/api/admin/v1/taxonomies` | 🕳️ UNUSED_ROUTE | ✅ | ❌ | 🆕 Novo (não bloqueante) |
