...
- `docs/agents-internal/github-actions-secrets.md`
- `docs/agents-internal/infra-map.md`
...
7. Revisar docs e apontar onde condensar:
   ...
   - `docs/agents-internal/infra-map.md` so prereqs/topologia;
   - `docs/agents-internal/github-actions-secrets.md` so nomes/caminhos de secrets.
