...
// Quantas chamadas de medição num turno já caracterizam investigação. Abaixo
// disso é operação de rotina (um `ls`, um `git status`) e cobrar seria hostil —
// gate que reprova demais acaba desligado.
const MINIMO_DE_MEDICOES = 4;
