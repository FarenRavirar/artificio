...
description: Auditoria de UX ampla pelos 7 fatores da IxDF, 5 características de usabilidade e 5 dimensões de interação, com proposta de redesenho. Use quando o pedido for repensar um fluxo inteiro (não revisar uma tela), ao investigar por que um fluxo tem abandono, ou quando pedirem "auditoria de UX", "repensar essa experiência", "esse fluxo está ruim".
---
