...
description: Referência de diretrizes de design web (layout, tipografia, cor, responsividade) para consulta durante implementação de tela. Use ao construir interface nova e precisar de referência de boa prática, ou quando perguntarem "qual o padrão para isso?" numa decisão de layout.
metadata:
  author: vercel
