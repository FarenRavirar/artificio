...
description: Avalia design visual de uma tela: tipografia, cor, espaçamento, hierarquia, consistência e convenção da categoria de produto. Use ao revisar PR de frontend, ao criar tela nova, ou quando pedirem "revisão de design", "o visual está bom?", "está polido?". Para conformidade com o design system compartilhado (@artificio/ui, tokens, régua de espaçamento), usar `ui-fidelity-audit`.
---
