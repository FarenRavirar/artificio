---
name: review-changes
description: Revisão de código estruturada sobre as mudanças da branch, com detecção de impacto pelo grafo. Use ao revisar diff antes de abrir PR, ou quando pedirem "revisa minhas mudanças", "olha esse diff". Para o laço com os bots na PR já aberta, usar `ciclo-de-review`.
---
