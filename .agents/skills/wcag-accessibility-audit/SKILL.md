...
description: Auditoria de acessibilidade web contra WCAG 2.1/2.2 pelos 4 princípios POUR (perceptível, operável, compreensível, robusto), com níveis A/AA/AAA. Use ao revisar PR de frontend, antes de publicar página pública, ou quando pedirem "acessibilidade", "WCAG", "leitor de tela", "contraste", "navegação por teclado".
---
