...
description: Audita usabilidade de uma tela/fluxo pelas 10 heurísticas de Jakob Nielsen (visibilidade de estado, controle do usuário, consistência, prevenção de erro, reconhecimento, flexibilidade, estética, recuperação de erro, ajuda). Use ao revisar PR de frontend, antes de fechar uma tela nova, ou quando pedirem "auditoria de usabilidade", "heurísticas de Nielsen", "isso está usável?" — o AGENTS.md exige as 10 heurísticas e ISO 9241-11 em toda mudança de interface.
---
