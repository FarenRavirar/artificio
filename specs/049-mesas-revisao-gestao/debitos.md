...
| D06 | 8 issues P1 das auditorias não tratadas | Fase B | Issues P1-1 a P1-8 documentadas em `auditorias-consolidadas.md`. Escopo: modal a11y (P1-1), labels checkbox (P1-2), focus indicators (P1-3), dirty state guard (P1-4), window.confirm unificação (P1-5), navegação automática (P1-6), design system (P1-7), erro para leitores de tela (P1-8). **→ TRANSFERIDO p/ spec 053 (DEB-053-01, Frente A) em 2026-06-27.** Não retrabalhar aqui. |
