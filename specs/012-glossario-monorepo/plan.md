...
- Subdomínio/DNS: BETA `glossariobeta.`; PROD futuro `glossario.` + 301 do `glossariorpg.` (supera parte do D017 — registrar D057/D0NN).
...
- Hostname: remover rota nova do tunnel; `glossariorpg.` segue servindo enquanto o redirect nao for criado.
