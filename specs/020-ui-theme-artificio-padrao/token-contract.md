...
- Hoje valida: `ink`, `brand`, `brandDeep`, `focus`, `muted`, `line`, `surface`, `canvas`, `charcoal`, `navy`, `bronze`.
...
- estados semanticos completos (`success`, `warning`, `danger`, `info`);
- spacing e shadow completos;
- tokens dark estruturados (`dark.canvas`, `dark.surface`, `dark.text`, `dark.line`);
- primitives/recipes que consomem esses tokens.
