...
|---|---|---|---|---|---|
| BL-INFRA-WORKFLOWS-026 | aberto (auditoria) | `specs/026-infra-workflows-audit/`, `sessoes/26-06-16_10_infra_workflows-audit.md` | `.github/workflows/*`, esteira CI/CD | auditoria feita; falta executar fatias F1-F10 (path-filters, pin actions, env-by-ref central, manifesto+matrix, accounts->`_deploy-module`, ports->expose, cron seguro, updates app, cap cache imagem) | aprovar/executar F1-F10 uma a uma, cada com smoke/rollback proprios; nada implementado nesta fatia |
...
| BL-UI-COPYRIGHT-027 | local | `specs/027-ui-copyright-usage/`, `sessoes/26-06-16_11_ui-copyright-usage.md` | `packages/ui`, `apps/site` | página `/termos-de-uso-e-direitos-autorais/` e resumo no rodapé universal implementados localmente; builds `ui`/`site` verdes; falta commit/push/deploy autorizado para chegar aos hosts | quando o mantenedor pedir, commitar/pushar e publicar via esteira beta antes de promover |
