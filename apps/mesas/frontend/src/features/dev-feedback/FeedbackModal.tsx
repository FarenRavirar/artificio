      ...
      >
        ...
        <div className="mb-4 grid grid-cols-2 gap-2" role="group" aria-label="Tipo de feedback">
          <button
            ...
            className={`rounded-lg px-4 py-2 text-sm font-semibold transition-all ${
              kind === 'bug' ? 'bg-artificio-orange text-[#020740]' : 'bg-white/5 text-white/60 hover:bg-white/10'
            }`}
          >
            🐞 Problema
          </button>
          <button
            ...
            className={`rounded-lg px-4 py-2 text-sm font-semibold transition-all ${
              kind === 'suggestion' ? 'bg-artificio-orange text-[#020740]' : 'bg-white/5 text-white/60 hover:bg-white/10'
            }`}
          >
            💡 Sugestao
          </button>
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            ...
            disabled={submitting}
            className="rounded-lg bg-artificio-orange px-5 py-2 text-sm font-semibold text-[#020740] transition-colors hover:bg-artificio-orange-hover hover:text-white disabled:cursor-not-allowed disabled:opacity-50"
          >
