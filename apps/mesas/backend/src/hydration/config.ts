// T7.2 (spec 096): `imported_expires_at` saiu desta lista — a coluna foi
// DERRUBADA pela migration_99 (`DROP COLUMN IF EXISTS`) e não existe no banco
// (`information_schema` medido em produção: ausente). Um allowlist que nomeia
// coluna inexistente é bug esperando o primeiro SELECT que o use.
