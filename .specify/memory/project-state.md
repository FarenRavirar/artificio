...
14. **Spec 047** (mesas inbox importação) — **PR #88 merged (`d2262a0`, 2026-06-23).** **PR #89 (chore/047-debitos-finais)** — 9 CodeRabbit reviews investigados/implementados: refatoração useReducer, dirty tracking, normalizador SystemTreeNode, API_BASE compartilhada, acessibilidade radios, guarda synced, reviewNotes fix. Lint 15/15, build 17/17, backend 178 tests ✅, PR checks 33/33 ✅. Pendente: merge PR #89, redeploy beta, smoke T1.13-T1.16. **Não promovido a `main`.**
