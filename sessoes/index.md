...
| `26-06-18_1_site_cutover-prod` | 2026-06-18 | site/deploy | Spec 029: promote dev→main + redeploy PROD consumidores UI (Portal→raiz). Continua: Spec 030 Fase 0 (F1-F3: compose prod, manifest paridade, noindex beta) | spec 029 fechada; spec 030 Fase 0 codigo pronto, T4 (PR) pendente |
