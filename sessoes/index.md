...
| `26-06-13_1_ui-theme-020-b6b7-e2e-prod` | 2026-06-13 | glossário/mesas/ui | Spec 020 B6/B7 E2E prod + fixes locais + B10b/B11 tokens | aberta (PR #26 promovido/deployado; B6 ✅; B7 reaberto por `/perfil` light + hero banner, fix local pendente publicar/revalidar) |
| `26-06-14_1_release-prod-feedback-dmesas1-nginx` | 2026-06-14 | glossário/mesas/docs | Release prod: Spec 021 feedback + D-MESAS1 + shell/nginx glossário (D-NGINX1 v2/D-SHELL1b) | concluída (promote+deploy prod verde; D-NGINX1/D-SHELL1b fechados; D-NGINX2 aberto; docs uncommitted) |
| `26-06-15_1_mesas_nginx-realip` | 2026-06-15 | infra/mesas/glossário/accounts/site | Spec 023: contrato Real IP para Cloudflare Tunnel → artificio_net → apps | aberta (local; sem commit/push/deploy) |
