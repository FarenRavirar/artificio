...
| `26-06-07_1_infra_docker-cleanup` | 2026-06-07 | infra/CI-CD | Docker cleanup semanal (migra do legado mesas) + quiescência | aberta (SDD Lite; código + review ✅; aguarda aprovação commit/push) |
