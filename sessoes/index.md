...
| `26-06-16_11_ui-copyright-usage` | 2026-06-16 | ui/site | Spec 027: página de termos de uso e direitos autorais + resumo no rodapé universal | local (builds `ui`/`site` verdes; falta commit/push/deploy autorizado) |
