...
## Estado atual
**Fase 1 ✅ concluída (smoke 200).** VM nova `<IP_DA_VM>` (aarch64/Ubuntu24/193G), Docker+`artificio_net`, tunnel Cloudflare correto conectado, glossário+mesas restaurados e no ar, dados intactos (glossário prod 8808 terms / beta 8785; mesas 48 tab), sem telegram/foundry.
