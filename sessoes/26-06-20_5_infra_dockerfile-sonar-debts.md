...
- [x] `apps/glossario/frontend/Dockerfile:35` — `RUN apk add --no-cache libexpat=2.8.1-r0` (CVE-2026-45186/41080, Snyk)
- [x] `apps/mesas/frontend/Dockerfile:48` — `RUN apk add --no-cache libexpat=2.8.1-r0` (CVE-2026-45186/41080, Snyk)
