...
// G7 (spec 099): contrato de fonte server-side e normalizador agora vivem em
// `catalogFetch.ts`, compartilhados com o `CatalogTree`, que passou a oferecer
// o mesmo contrato. Antes moravam aqui; o `CatalogTree` não podia importá-los
// deste arquivo sem fechar um ciclo (este importa daquele).
import {
  SYSTEM_SEARCH_DEBOUNCE_MS,
  normalizeNodes,
  type CatalogSystemSearchFetch,
  type CatalogSystemChildrenFetch,
  type CatalogSystemPathFetch,
...
// Os três tipos de fetch são re-exportados daqui para não quebrar quem já os
// importa deste módulo; a definição vive em `catalogFetch.ts` (G7).
export type {
